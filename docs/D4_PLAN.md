...
| Odoo planner places MO → adapter polls + creates `Reservation` | `START_ACTIVITY` (standard) | `erp/odoo` (free-form string — codex round-8 chose this over `REMOTE_SUPERVISOR`/`UNKNOWN_AGENT`) | `MODALITY_OTHER` | `{"activity":"manufacturing_order","goal":"fulfill_kit","object":{"type":"bom","id":"<bom_id>"},"project_id":"urn:ngsi-ld:Project:...","bom":[{"sku":"...","qty":...}]}` | **Used — implemented in Sprint 0.4** |
